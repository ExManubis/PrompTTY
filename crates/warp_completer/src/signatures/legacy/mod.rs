...
impl CommandRegistry {
    ...
    fn register_warp_signatures(registry: &Self) {
        // We use this instance's CLI signature. This is not entirely accurate — the user
        // might be SSHed into a host with a different version of the CLI — but it'll be
        // close enough, and this approach keeps CLI completions up to date.
        let bin_name = Channel::Release.cli_command_name();
